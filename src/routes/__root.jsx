    ...
    <nav className="flex justify-between items-center bg-orange-400 px-20 py-2">
      ...
      {!session ? (
        <div className="flex items-center space-x-2">
          <button type="button" className="px-5 py-2 rounded bg-gray-100 hover:bg-orange-500 hover:text-white">
        ...
        <div className="gap-2 flex">
          <Link to="/profile" className="px-5 py-2 rounded bg-gray-100 hover:bg-orange-500 hover:text-white">
            Profile
          </Link>
          <button
            type="button"
